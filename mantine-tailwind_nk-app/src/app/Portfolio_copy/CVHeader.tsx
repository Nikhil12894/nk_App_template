import { IconAt, IconBrandGithub, IconBrandLinkedin, IconDownload, IconMapPin, IconPhone } from "@tabler/icons-react";
    ...
    <div className="grid grid-cols-6 gap-4">
      <div className="col-start-1 col-span-4 lg:col-span-5">
        ...
        >
          ...
          <a href="./Nalin_CV.pdf" title="download">
            <IconDownload
              stroke={2}
              className="h-6 w-6 ml-2 text-muted-foreground hover:text-black/50 dark:hover:text-white/50 cursor-pointer"
            />
          </a>
          {/* <span title="switch mode" className="ml-4">
            <ModeToggle />
          </span> */}
        </h1>
        ...
        <ul className="flex flex-wrap text-xs lg:text-lg">
          <li className="mr-4 flex items-center justify-center cursor-pointer ">
            <IconAt stroke={2} className="h-4 w-4 mr-2 text-teal-600" />
          ...
          <li className="mr-4 flex items-center justify-center cursor-pointer ">
            <IconPhone stroke={2} className="h-4 w-4 mr-2 text-teal-600" />
            <span className="hover:text-black/50 dark:hover:text-white/50">
              {headerData.header.phone}
            </span>
          </li>
          <li className="mr-4 flex items-center justify-center cursor-pointer">
            <IconMapPin stroke={2} className="h-4 w-4 mr-2 text-teal-600" />
        ...
        <h3 className="text-xs lg:text-lg text-muted-foreground flex items-center">
          <IconBrandGithub stroke={2} className="h-4 w-4 mr-2 text-teal-600" />
